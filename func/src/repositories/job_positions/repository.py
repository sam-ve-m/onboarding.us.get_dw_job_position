...
# PROJECT IMPORTS
from func.src.domain.employ_positions.model import EmployPositionsResponse
from func.src.repositories.base_repository.oracle.base import OracleBaseRepository
from func.src.repositories.cache.repository import EmployPositionsCacheRepository
