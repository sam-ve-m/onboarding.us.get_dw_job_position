...
fission fn create --spec --name get-employ-positions-fn --env get-employ-positions-env --src "./func/*" --entrypoint main.get_employ_positions --executortype newdeploy --maxscale 3
