...
# STUB IMPORTS
from tests.src.employ_positions.stub_service import response_service_stub
...
@pytest.mark.asyncio
@patch.object()
@patch.object(EmployPositionsService, "get_employ_positions_response", side_effect=[response_service_stub, {}])
...
async def test_when_sending_right_params_to_get_employ_positions_then_return_the_expected(
    ...
    Iterable.__next__ = mock_get_response
    app = Flask(__name__)
